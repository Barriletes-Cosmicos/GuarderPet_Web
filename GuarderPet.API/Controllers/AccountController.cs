...
namespace GuarderPet.API.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(DataContext dataContext, IUserHelper userHelper, ICombosHelper combosHelper, IBlobHelper blobHelper, IMailHelper mailHelper)
        {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Response response = _mailHelper.SendMail(model.Username, "Guarder Pet - Confirmación de cuenta", $"<h1>Guarder Pet - Confirmación de cuenta</h1>" +
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(model.Email, "Guarder Pet - Reseteo de contraseña", $"<h1>Guarder Pet - Reseteo de contraseña</h1>" +
